...
## Checklist de Requerimientos - PFO1
...
- [x] Layout organizado mediante Flexbox, especialmente en la sección de tarjetas.
- [x] Diseño responsivo utilizando unidades relativas (%, rem, vh) para adaptarse a móviles.
- [x] Implementación de transiciones y efectos hover en tarjetas e imágenes.
- [x] Estilización personalizada de tablas, botones y formularios de contacto.

### 3. Contenido HTML (Estructura Semántica)
- [x] Declaración DOCTYPE e idioma configurado en español (lang="es").
- [x] Metaetiquetas obligatorias incluidas: charset y viewport.
- [x] Estructura con secciones identificadas por ID: sobre-mi, tarjetas, habilidades, contacto y peliculas.
- [x] Barra de navegación (nav) funcional con enlaces internos.
- [x] Inclusión de al menos 4 comentarios explicativos detallando la lógica del código.
